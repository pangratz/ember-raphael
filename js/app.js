...
App.RaphaelPaper = Ember.Object.extend({
    ...
    pathDidChange: function() {
        ...
        // draw the path
        var p = this.paperObject.path(this.path).attr({
            fill: this.fill,
            stroke: this.stroke
        });
        // apply the scale
...
App.snippetsController = Ember.Object.create({
    pasteOctocat: function() {
        Ember.setPath("App.papers.main.path", Paths.Octocat);
    },
    pasteApple: function() {
        Ember.setPath("App.papers.main.path", Paths.Apple);
    },
    pasteChrome: function() {
        Ember.setPath("App.papers.main.path", Paths.Chrome);
    },
    pasteTwitter: function() {
        Ember.setPath("App.papers.main.path", Paths.Twitter);
    }
});
